...
if (!isset($_SESSION['USER'])) {
    ...
    try {
        ...
        $sql = "SELECT order.check, bento.date, bento.name, bento.price FROM ordertable as order ";
        $sql .= "LEFT OUTER JOIN bentotable as bento ON order.id = bento.id WHERE order = ". $_SESSION['USER'];
