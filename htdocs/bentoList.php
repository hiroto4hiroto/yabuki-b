...
if (isset($_SESSION['VENDER'])) $isVENDER = 'true';
    ...
    try {
        ...
        foreach ($prepare->fetchAll(PDO::FETCH_ASSOC) as $result)
        {
            ...
            if ($result["date"] != date( "Y-m-d", strtotime( $getdate ." + 1 day" ) )) $plusStyle = ' class="notTodayOrder" ';
            ...
            $list .= '<td'.$plusStyle.' style="min-width: 70%; background-image: url(\'data:image/jpeg;base64,'. base64_encode($result["image"]) .'\'); background-size: cover; background-position: center;">';
            $list .= '<td'.$plusStyle.' style="max-width: 30%;">';
